...
from above code when select image from editor it will store image in upload/complain_images/customer/ folder.But when click on <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> or <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button> but doesn't submit the form (i.e., they don't hit the "Send Reply" button),it will remove image from upload/complain_images/customer/ folder.Again when i open modal it will show previous image in editor whic is not correct.
